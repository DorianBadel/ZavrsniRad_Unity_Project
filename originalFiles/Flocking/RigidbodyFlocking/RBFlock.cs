...
public class RBFlock : MonoBehaviour
{
    internal RBFController controller;
    ...
    // void Update(){
    //     float singleStep = controller.rotSpeed * Time.deltaTime;
    //         Vector3 newDirection = Vector3.RotateTowards(this.transform.position,
    //         controller.target.localPosition
    //         ,singleStep, 0f);
    ...
    // }
     ...
     private Vector3 Steer() {
        ...
        foreach (RBFlock flock in controller.flockList) {
            if (flock != this) {
